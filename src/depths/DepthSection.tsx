...
const DepthSection: React.FC<DepthSectionProps> = ({ label, depthM, depthFromM, children }) => (
  <section className="mt-20">
    <div className="flex items-baseline justify-between border-t border-moon/15 pt-4 font-mono text-[11px] uppercase tracking-[0.22em] text-moon/70">
      <h2 className="font-mono text-[11px] font-normal">{label}</h2>
